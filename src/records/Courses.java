...
public class Courses implements CourseDetails {
    ...
    // to store course and there credit <course_code, credits>
    ...
    public void addCourse() {
        ...
        if (course_count > 0) System.out.println("(ENTER COURSE_CODE and CREDITS separated by SPACE)");
    ...
    // display registered courses for particular Exam
    static void display(Courses obj) {
        System.out.println("\n@[REGISTERED COURSES](Course : Credits) :");
        if (obj.courses.size() == 0) System.out.println("  + NO COURSE ADDED FOR THIS EXAM");
        obj.courses.forEach((key, value) -> System.out.println("   " + key + " : " + value));
        System.out.println();
    }
}
